        ...
        <div className="boss-choice-list__content">
            ...
            <div className="boss-choice-list__controls">
                ...
                <label className="boss-choice-list__radio-label">
                  <Field name="employementStatus" component="input" value="1" type="radio" className="boss-choice-list__radio-button" />
                  <span className="boss-choice-list__radio-label-text">I have supplied my P45 from my previous employer</span>
                </label>
                <label className="boss-choice-list__radio-label">
                  <Field name="employementStatus" component="input" value="2" type="radio" className="boss-choice-list__radio-button" />
                ...
                <label className="boss-choice-list__radio-label">
                  <Field name="employementStatus" component="input" value="3" type="radio" className="boss-choice-list__radio-button" />
                ...
                <label className="boss-choice-list__radio-label">
                  <Field name="employementStatus" component="input" value="4" type="radio" className="boss-choice-list__radio-button" />
                  <span className="boss-choice-list__radio-label-text">I have another job or receive a state/occupational pernsion</span>
                </label>
                <label className="boss-choice-list__radio-label">
                  <Field name="employementStatus" component="input" value="5" type="radio" className="boss-choice-list__radio-button" />
